...
/**
 ...
 activity.
 */
struct ExerciseType: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .exerciseType
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Types of Exercise", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"image","image":"exercisetype.png"],
            optional: false
        )
        return activity
    }
