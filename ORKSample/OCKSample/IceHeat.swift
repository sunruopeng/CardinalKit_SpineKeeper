...
/**
 ...
 activity.
 */
struct IceHeat: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .iceHeat
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Ice and/or Heat", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"image","image":"iceheat.png"],
            optional: false
        )
        return activity
    }
