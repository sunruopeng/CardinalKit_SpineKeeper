...
/**
 ...
 activity.
 */
struct SummaryFacts: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .summaryFacts
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Summary: Back Pain Facts", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"html","html":"summaryfacts"],
            optional: false
        )
        return activity
    }
