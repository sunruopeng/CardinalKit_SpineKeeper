...
/**
 ...
 activity.
 */
struct CopingRefresher2: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .copingRefresher2
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Refresher: Coping with Pain (2 of 2)", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"html","html":"copingrefresher2"],
            optional: false
        )
        return activity
    }
