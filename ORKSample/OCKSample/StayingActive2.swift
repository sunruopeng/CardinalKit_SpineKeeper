...
/**
 ...
 activity.
 */
struct StayingActive2: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .stayingActive2
    ...
    func carePlanActivity() -> OCKTask? {
        ...
        activity.userInfo = ["hasTask":"html","html":"stayingactive2"]
        return activity
    }
