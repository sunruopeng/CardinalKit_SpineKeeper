...
/**
 ...
 activity.
 */
struct NassVideo1: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .nassVideo1
    /* Junaid Commnented
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Regular Exercise", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"video","video":"nass1"],
            optional: false
        )
