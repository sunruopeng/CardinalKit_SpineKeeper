...
/**
 ...
 activity.
 */
struct CopingRefresher1: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .copingRefresher1
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Refresher: Coping with Pain (1 of 2)", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"html","html":"copingrefresher1"],
            optional: false
        )
        return activity
    }
