...
/**
 ...
 activity.
 */
struct Guidelines: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .guidelines
    /* Junaid Commnented
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Physical Activity Guidelines", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"html","html":"guidelines"],
            optional: false
        )
        return activity
    }
