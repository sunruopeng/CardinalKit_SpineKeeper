...
/**
 ...
 activity.
 */
struct NassVideo9: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .nassVideo9
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Weekend Warriors", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"video","video":"nass9"],
            optional: false
        )
