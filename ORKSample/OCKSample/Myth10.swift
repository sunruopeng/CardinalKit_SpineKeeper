...
/**
 ...
 activity.
 */
struct Myth10: Activity {
    // MARK: Activity
    
    let activityType: ActivityType = .myth10
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Sleeping Myths (10 of 10)", comment: "")
        ...
        let activity = OCKCarePlanActivity.intervention(
            ...
            imageURL: nil,
            schedule: schedule,
            userInfo: ["hasTask":"html","html":"myth10"],
            optional: false
        )
